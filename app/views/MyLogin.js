...
export class MyLogin extends React.Component {
  constructor(props) {
    super(props);
    this.state = { email: "", password: "", dialogVisible: false };
  }
  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <TouchableOpacity>
          <Text style={styles.forgot} onPress={this.showDialog}>Forgot Password?</Text>
        </TouchableOpacity>
        <TouchableOpacity>
          <Text style={styles.signup} onPress={() => { this.props.navigation.navigate("Register"); }} >Sign Up</Text>
        </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  signup: { color: "#003f5c", fontSize: 14, marginTop: 10 },
  loginBtn: { width: "80%", backgroundColor: "#fb5b5a", borderRadius: 25, height: 50, alignItems: "center", justifyContent: "center", marginTop: 20, marginBottom: 10 },
